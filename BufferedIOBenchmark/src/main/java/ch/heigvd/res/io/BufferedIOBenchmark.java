...
public class BufferedIOBenchmark {
	...
	// Création du fichier csv dans lequel nous allons écrire.
	...
	private void produceTestData(IOStrategy ioStrategy, long numberOfBytesToWrite, int blockSize) {
		...
		try {
            ...
            ecrireFichier.write("WRITE;" + ioStrategy + ";" + blockSize + ";" + numberOfBytesToWrite + ";" + temps + "\n");
		}catch(IOException e) {
			e.printStackTrace();
		}
	}
	...
	private void consumeTestData(IOStrategy ioStrategy, int blockSize) {
		...
		try {
			...
			ecrireFichier.write("READ;" + ioStrategy + ";" + blockSize + ";" + NUMBER_OF_BYTES_TO_WRITE + ";" + temps + "\n");
	...
	public static void main(String[] args) {
		...
		try{
			...
			ecrireFichier.write("operation;strategy;blockSize;fileSizeInBytes;durationInMs\n");
